...
function configureAws(region, cognitoIdentityPoolId) {
    global_1.default.config.region = region;
    global_1.default.config.credentials = new global_1.default.CognitoIdentityCredentials({
...
class AwsIotBrowserClient {
    ...
    authenticate() {
        ...
        return new Promise(async (resolve, reject) => {
            const identity = new cognitoidentity_1.default();
            const creds = global_1.default.config.credentials;
